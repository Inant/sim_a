              ...
              foreach ($kelas as $item) {
                ...
                <tr>
                  ...
                  <td style="text-align: center;">
                    <button type="button" class="btn btn-sm btn-success " onclick="edit('<?php echo $item->id_kelas; ?>')"><i class="fa fa-edit"></i>  Edit</button>
                    <a href="<?php echo base_url() . 'kelas/hapus'; ?>/<?php echo $item->id_kelas ?>" class="btn btn-danger"onClick="return doconfirm();"><i class="fa fa-trash"></i> Hapus</a>
...
<div class="modal fade bs-example-modal-md" id="modaladd" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-md modal-dialog-centered">
    <div class="modal-content">
      <form method="POST" name="input-kelas" action="<?php echo base_url(). 'kelas/add'; ?>" >
        <div class="modal-header">
          <h4 class="modal-title" id="myLargeModalLabel">Tambah Data Kelas</h4>
        ...
        <div class="modal-body">
          <div class="form-group col-md-12">
            ...
            <input type="text" name="nama_kelas" class="form-control form-control-line" required="">
          </div>
        </div>
